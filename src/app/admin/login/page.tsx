        ...
        <div className="bg-white/70 backdrop-blur-lg border border-white/40 rounded-[20px] p-8 shadow-sm flex flex-col gap-6 relative overflow-hidden">
          <form onSubmit={handleAdminLogin} className="flex flex-col gap-5 relative z-10">
            <div className="flex flex-col gap-2">
              <label htmlFor="username" className="text-xs font-medium text-slate-500 flex justify-between">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="password" className="text-xs font-medium text-slate-500 flex justify-between">
                <span>Password</span>
