    ...
    <main className="pt-20 md:pt-8 px-4 md:px-8 pb-24 md:pb-8 w-full grow">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Overview of election progress and turnout.</p>
        </div>

        <div className="relative min-w-50">
          <label className="text-xs font-medium text-slate-500 mb-1.5 block">Filter by Class</label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl p-6 shadow-sm shadow-slate-200/50">
          ...
          <p className="text-xs font-medium text-slate-500 mt-5">Students yet to cast their ballot</p>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl p-6 shadow-sm shadow-slate-200/50">
          ...
          <p className="text-xs font-medium text-slate-500 mt-5">Currently logging in or voting</p>
        </div>
      </div>
